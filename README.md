...
**Desenvolvedor Front-End** | React • Next.js • TypeScript | AWS Certified Cloud Practitioner

Estudante de Engenharia de Software pela UTFPR, atualmente construindo interfaces web performáticas e escaláveis na Domus Control.
...
🔹 [aplicativo-de-formulário-multi-etapas-para-flugo](https://github.com/VictorTavaresRafael/multi-step-form-app-for-flugo)<br>
🔹 [sistema-de-venda-de-ingressos](https://github.com/VictorTavaresRafael/ticket-sales-system)<br>
🔹 [victor_rafael — trajetória Compass UOL / Engenharia de Dados em Nuvem AWS](https://github.com/VictorTavaresRafael/victor_rafael)
